<?php /* Smarty version 2.6.19, created on 2012-03-08 08:26:25
...
:</label>
				<input type = "text"  name = "dateformat" id = "dateformat" value = "<?php echo $this->_tpl_vars['settings']['dateformat']; ?>
" / >
			</div>
