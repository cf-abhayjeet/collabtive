<?php /* Smarty version 2.6.19, created on 2012-03-08 08:29:13
...
<?php endif; ?>
			...
			<?php endif; ?>
				...
				<form novalidate class="main" method="post" action="managemilestone.php?action=edit&amp;id=<?php echo $this->_tpl_vars['milestone']['project']; ?>
...
:</label>
							<input type="text" value="<?php echo $this->_tpl_vars['milestone']['name']; ?>
...
:</label>
							<input type="text" value="<?php echo $this->_tpl_vars['milestone']['endstring']; ?>
